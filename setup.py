...
setup(
    ...
    description="Fast constrained linear assignment problem (CLAP) solvers for Python",
    entry_points={"console_scripts": ["my_example=clapsolver.bin.my_example:main"]},
    ...
    url="https://github.com/jdmoorman/clapsolver",
